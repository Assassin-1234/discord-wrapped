			...
			<div className="flex h-screen w-screen fixed top-0 left-0 z-20">
				<div className="m-auto bg-gray rounded-3xl p-10 w-[95%] md:w-11/12 h-[95%] md:h-5/6 flex flex-col">
					<div className="flex flex-col items-center justify-center text-center">
						<h1 className="text-white text-4xl md:text-6xl mt-0 md:mt-5 font-bold">Demo</h1>
					</div>

					<div className="flex-grow flex items-center justify-center relative">
						<div className='relative w-full md:w-[40%]'>
							<div style={{ position: 'relative' }}>
								<video className='flex rounded-xl z-0 cursor-pointer w-full h-auto' ref={videoRef} src='/demo.mp4' onClick={handlePlay} onEnded={handleEnded}></video>
